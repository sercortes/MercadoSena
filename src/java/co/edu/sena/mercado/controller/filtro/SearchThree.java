...
//        String ciudad = request.getParameter("ciudades");
        ...
        empresaDTO empresa = new empresaDTO();
        empresa.setCentro(vendedores);
        ArrayList<Producto> listaProductos = productoDAO.getProductsByNameSeller(producto, empresa);
        productoDAO.CloseAll();
        response.setContentType("application/json");
        new Gson().toJson(listaProductos, response.getWriter());
    }
    ...
    private void getProductsByNameCategoryCitySeller(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        empresaDTO empresa = new empresaDTO();
        empresa.setCentro(vendedores);
        ArrayList<Producto> listaProductos = productoDAO.getProductsByNameCategoryCitySeller(producto, empresa);
        productoDAO.CloseAll();
        response.setContentType("application/json");
        new Gson().toJson(listaProductos, response.getWriter());
...
//        producto.setNombreProducto(palabra);
        ...
        empresaDTO empresa = new empresaDTO();
        empresa.setCentro(vendedores);
        ArrayList<Producto> listaProductos = productoDAO.getProductsByCategoryCitySeller(producto, empresa);
        productoDAO.CloseAll();
        response.setContentType("application/json");
        new Gson().toJson(listaProductos, response.getWriter());
