...
//    private String main = "https://carwaystore.com/Store";
        ...
        try {
            ...
            message.setText(
                    ...
                    + "            <input type=\"hidden\" value=\"" + codigo + "\" name=\"codigo\">"
                                + "<br/><a href=\""+this.urlActivate+"?route=activateUser&usuario="+dest+"&codigo="+codigo+"\" type=\"submit\" target=\"_blank\" class=\"button  arrow\" style='display: inline-block;position: relative;padding: 0.8em 1.4em;background: #b93333;border: none;color: white;'>Ingresar a CAR WAY</span> <span class=\"il\"></span></a><br/>"
                    + "          \n"
                    + "            <br>\n"
                    + "            </form>\n"
                    //                    + "<a style='color: rgb(0, 128, 0);' href='http://181.48.181.131/MercadoSena/activarCuenta?usuario=" + dest + "&codigo=" + codigo + "'><p>Click aquí para activar tu cuenta</p></a>"
    ...
    public boolean recuperarCorreo(String dest, String codigo) throws MessagingException {
        try {
            ...
            message.setText(
                    ...
                    + "            <div style='background: #b93333'><img style='width: 30%; margin-left: 34%;margin-top: 1%;' src=\"https://carwaystore.com/Store/assets/images/icons/LOGO3.png\"></div>"
                    + "            <p>CARWAY.</p>"    
                    + "            <p>Para terminar,haz clic en el siguiente botón para restablecer tu contraseña:</p>"
                    + "            <p><b>Usuario: </b>" + dest + "</p>"
                    + "  <form action=\"" + this.recover + "\" method=\"POST\" >"
                    + "            <input type=\"hidden\" value=\"" + dest + "\" name=\"usuario\">"
                    + "            <input type=\"hidden\" value=\"" + codigo + "\" name=\"codigo\">"
                           + "<br/><a href=\""+this.recover+"?route=correoUser&usuario="+dest+"&codigo="+codigo+"\" type=\"submit\" target=\"_blank\" class=\"button  arrow\" style='display: inline-block;position: relative;padding: 0.8em 1.4em;background: #b93333;border: none;color: white;'>Ingresar a CAR WAY</span> <span class=\"il\"></span></a><br/>"
                    + "          \n"
                    + "            <br>\n"
                    + "            </form>\n"
                    //                    + "<a style='color: rgb(0, 128, 0);' href='http://181.48.181.131/MercadoSena/activarCuenta?usuario=" + dest + "&codigo=" + codigo + "'><p>Click aquí para activar tu cuenta</p></a>"
    ...
    public boolean passCorreo(String dest, String codigo) throws MessagingException {
        try {
            ...
            message.setText(
                    ...
                    + "            <div style='background: #b93333'><img style='width: 30%; margin-left: 34%;margin-top: 1%;' src=\"https://carwaystore.com/Store/assets/images/icons/LOGO3.png\"></div>"
                    + "            <p>CARWAY.</p>"    
                    + "            <p>Tu clave ha sido modificada y es la siguiente:</p>"
                    + "            <p><b>Clave: </b>" + codigo + "</p>"
                            + "<br/><a href=\""+this.main+"\" type=\"submit\" target=\"_blank\" class=\"button  arrow\" style='display: inline-block;position: relative;padding: 0.8em 1.4em;background: #b93333;border: none;color: white;'>Ingresar a CAR WAY</span> <span class=\"il\"></span></a><br/>"
                    //                    + "<a style='color: rgb(0, 128, 0);' href='http://181.48.181.131/MercadoSena/activarCuenta?usuario=" + dest + "&codigo=" + codigo + "'><p>Click aquí para activar tu cuenta</p></a>"
                    + "            <footer style=' background: rgb(252, 252, 252);height: 39px;padding: 15px;text-align: center;'>"
                    + "                <div >"
