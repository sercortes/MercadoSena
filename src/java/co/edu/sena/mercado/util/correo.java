    ...
    public boolean recuperarCorreo(String dest, String codigo) throws MessagingException {
        try {
            ...
            message.setText(
                    ...
                    + "            <input type=\"hidden\" value=\"" + dest + "\" name=\"usuario\">"
                    + "            <input type=\"hidden\" value=\"" + codigo + "\" name=\"codigo\">"
                           + "<br/><button type=\"submit\" target=\"_blank\" class=\"button  arrow\" style='display: inline-block;position: relative;padding: 0.8em 1.4em;background: #b93333;border: none;color: white;'>Enviar</span> <span class=\"il\"></span></button><br/>"
                    + "          \n"
                    + "            <br>\n"
                    + "            </form>\n"
                    //                    + "<a style='color: rgb(0, 128, 0);' href='http://181.48.181.131/MercadoSena/activarCuenta?usuario=" + dest + "&codigo=" + codigo + "'><p>Click aquí para activar tu cuenta</p></a>"
